...
export function CavePainting() {
  return (
    <svg viewBox="0 0 200 140" width="100%" role="img" aria-label="Cave painting of a mammoth">
      <rect x="0" y="0" width="200" height="140" fill="#c8a165" />
      <path d="M0 110 Q100 80 200 110 L200 140 L0 140 Z" fill="#8c6a3f" />
      <g stroke="#5c3a1e" strokeWidth="4" fill="none" strokeLinecap="round">
...
export function RomanColumn() {
  return (
    <svg viewBox="0 0 200 140" width="100%" role="img" aria-label="Roman column and aqueduct">
      <rect x="10" y="60" width="180" height="14" fill="#e8d9b5" />
      {[30, 80, 130, 170].map((x, i) => (
        <rect key={i} x={x} y="20" width="18" height="90" fill="#e8d9b5" stroke="#b8a37a" strokeWidth="2" />
      ))}
      <rect x="0" y="110" width="200" height="30" fill="#4d96ff" opacity="0.5" />
    </svg>
  );
}
...
export function Caravel() {
  return (
    <svg viewBox="0 0 200 140" width="100%" role="img" aria-label="Portuguese caravel sailing the ocean">
      <rect x="0" y="95" width="200" height="45" fill="#4d96ff" />
      <path d="M40 95 L60 60 L150 95 Z" fill="#8c6a3f" />
      <line x1="100" y1="20" x2="100" y2="70" stroke="#5c3a1e" strokeWidth="4" />
      <path d="M100 22 L140 45 L100 62 Z" fill="#fff9e6" stroke="#c9c9c9" />
      <path d="M100 40 L70 55 L100 65 Z" fill="#fff9e6" stroke="#c9c9c9" />
...
export function Carnation() {
  return (
    <svg viewBox="0 0 200 140" width="100%" role="img" aria-label="Red carnation of the 25 de Abril revolution">
      <line x1="100" y1="70" x2="100" y2="135" stroke="#6bcb77" strokeWidth="5" />
      <circle cx="100" cy="55" r="10" fill="#ff6b6b" />
      {Array.from({ length: 10 }).map((_, i) => {
        const a = (i * Math.PI * 2) / 10;
        return <circle key={i} cx={100 + 22 * Math.cos(a)} cy={55 + 22 * Math.sin(a)} r="13" fill="#ff6b6b" opacity="0.85" />;
      })}
...
export function EuroCoin() {
  return (
    <svg viewBox="0 0 200 140" width="100%" role="img" aria-label="Euro coin symbolizing the adoption of the euro">
      <circle cx="100" cy="70" r="50" fill="#ffd93d" stroke="#c98f00" strokeWidth="5" />
      <circle cx="100" cy="70" r="36" fill="#4d96ff" />
...
export function ChampionCup() {
  return (
    <svg viewBox="0 0 200 140" width="100%" role="img" aria-label="Champion's cup for the 2016 European title">
      <path d="M75 30 h50 v35 a25 25 0 0 1 -50 0 Z" fill="#ffd93d" stroke="#c98f00" strokeWidth="4" />
      <path d="M75 40 Q50 40 50 60 Q50 75 75 72" fill="none" stroke="#c98f00" strokeWidth="5" />
      <path d="M125 40 Q150 40 150 60 Q150 75 125 72" fill="none" stroke="#c98f00" strokeWidth="5" />
      <rect x="90" y="95" width="20" height="20" fill="#ffd93d" stroke="#c98f00" strokeWidth="3" />
      <rect x="75" y="115" width="50" height="12" fill="#c98f00" />
    </svg>
  );
}
